...
# The {thing} things get filled in by magic later. I put the output directory
# and infile here so that you don't have to do double-backslashes like I had
# to here with the Render.exe call. (except for the very first ones, oddly.)
template = """"
REM Generated by write_multi_bat.py at {current_time}
C:\\Program Files\\Autodesk\\Maya2013\\bin\\Render.exe" -r arnold -rl shadow1 -s {start} -e {end} -ai:lfn C:\\Users\\jonathan\\Desktop\\poopLog_{proj}_{lognum}.log -rd {out} {infile}
...
class write_mult_bat(object):
    ...
    def render_data(self):
        ...
        output should be stored. The part you'll probably have to change here is
        the start/end statements. For now, they do 101+2*i and 101+(2*i+1) to
        get:
            i=0: 101-102
            i=1: 103-104... and so on...
        """
